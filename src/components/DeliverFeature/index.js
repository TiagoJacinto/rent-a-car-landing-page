...
export default function DeliverFeature() {
  ...
  return (
    <Container>
      <Grid>
        <div>
          <SectionTitle {...sectionTitleAnims}>DELIVERED TO YOUR DOOR.</SectionTitle>
          <Paragraph {...paragraphAnims}>
            Eleanor works with your schedule to have a white-glove delivery service
        ...
        <div>
          <div style={{ position: 'relative' }}>
            ...
            {isDesktop && <CarImage {...CarAnims} src={Porsche} />}
          </div>
        </div>
      </Grid>
    </Container>
